...
import MERN from "../assests/Rishi-Kashyap-02.pdf";
...
const Profile = () => {
  ...
  return (
    <section
      id="profile"
      className="bg-gradient-to-b from-gray-900 to-black text-white py-24 px-4 md:px-8 relative overflow-hidden min-h-screen flex items-center justify-center"
    >
      {/* Enhanced animated background */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div
          className="absolute top-40 left-10 w-80 h-80 bg-blue-500 rounded-full filter blur-[120px] opacity-15 animate-pulse"
          style={{ animationDuration: "15s" }}
        ></div>
        <div
          className="absolute bottom-20 right-10 w-96 h-96 bg-purple-600 rounded-full filter blur-[120px] opacity-10 animate-pulse"
          style={{ animationDuration: "20s" }}
        ></div>
        <div
          className="absolute top-1/4 right-1/4 w-72 h-72 bg-indigo-500 rounded-full filter blur-[100px] opacity-10 animate-pulse"
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div
          className={`flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 transform transition-all duration-1000 ${
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left order-2 md:order-1">
            ...
            <div className="mb-4 relative">
              ...
              <div
                className="h-1.5 w-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full mt-4 mx-auto md:mx-0"
                style={{
                  animation: isInView
                    ? "expand-line 1.5s forwards 0.5s"
                    : "none",
            ...
            <div className="mb-6">
              <h2
                className={`text-3xl md:text-4xl font-bold transition-all duration-500 bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-indigo-400 to-purple-400 ${
                  transitioning
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
              ...
              with experience in frontend technologies and a growing focus on
              the <span className="text-blue-400 font-medium">MERN Stack</span>.
              Skilled in creating dynamic UIs with{" "}
              ...
              I have worked with **Accernity UI** components and **ShadCN** to
              build modern, user-friendly interfaces. Currently expanding my
              backend skills with{" "}
              <span className="text-blue-400 font-medium">Node.js</span> and{" "}
              <span className="text-blue-400 font-medium">MongoDB</span>, while
              also learning TypeScript and advanced CSS tools.
            </p>
          ...
          >
            ...
            <div
              className={`absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 blur-md opacity-70 transform transition-all duration-700 ${
                hoverEffect ? "scale-110 rotate-[30deg]" : "scale-105 rotate-0"
              }`}
            ></div>
            <div
              className={`absolute inset-0 rounded-full bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 blur-sm opacity-80 transform transition-all duration-1000 ${
                hoverEffect ? "scale-105 rotate-[-20deg]" : "scale-100 rotate-0"
              }`}
            ></div>

            {/* Image container */}
            <div
              className="relative h-56 w-56 md:h-72 md:w-72 rounded-full overflow-hidden ring-4 ring-gray-800/50 transform transition-all duration-500 hover:scale-105"
              ref={imageRef}
            >
              <img
                src="https://t3.ftcdn.net/jpg/06/01/17/18/360_F_601171862_l7yZ0wujj8o2SowiKTUsfLEEx8KunYNd.jpg"
            ...
            <div
              className="absolute -bottom-2 -left-2 h-10 w-10 bg-purple-600 rounded-full flex items-center justify-center animate-bounce-slow opacity-90 shadow-lg"
