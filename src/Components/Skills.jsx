...
const Skills = () => {
  return (
    <section id="skills" className="p-8 bg-gradient-to-r from-black to-black text-white flex flex-col justify-center items-center">
      ...
      <ul className="list-none flex flex-wrap justify-center items-center gap-4 w-full md:w-3/4">
        {['React', 'Tailwind CSS', 'JavaScript (ES6)', 'Bootstrap', 'HTML', 'CSS', 'Node', 'Express', 'MongoDB', 'Problem Solving', 'Detail Oriented', 'Leadership'].map(skill => (
